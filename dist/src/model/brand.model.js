...
], BrandModel.prototype, "username", void 0);
__decorate([
    (0, sequelize_typescript_1.ForeignKey)(() => user_model_1.UsersModel),
    (0, sequelize_typescript_1.Column)(sequelize_typescript_1.DataType.UUID)
], BrandModel.prototype, "userId", void 0);
__decorate([
...
], BrandModel.prototype, "user", void 0);
exports.BrandModel = BrandModel = __decorate([
    (0, sequelize_typescript_1.Table)({ timestamps: true, tableName: "brands" })
], BrandModel);
