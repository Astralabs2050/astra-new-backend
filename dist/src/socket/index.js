...
const handleSocketConnection = (io) => {
    ...
    io.on("connection", async (socket) => {
        ...
        //get the brands
        socket.on("get_brands", async (data) => {
            try {
                ...
                const makersJob = await model_1.JobModel.findAll({
                    where: {
        ...
        socket.on("translation", async (data) => {
            ...
            try {
                ...
                const translatedMessage = await (0, handleMessages_1.translateMessage)(data.message, (_b = receiver === null || receiver === void 0 ? void 0 : receiver.dataValues) === null || _b === void 0 ? void 0 : _b.language);
